...
$(window).load(function() {
	...
	$('#paymentOptions #payer-type').live('change', function(event) {
		...
		$.get('getPTPaymentOptions.htm', paymentData, function(data) {
...
{
	$('#paymentOptions #payer-method').val("");
	clearPaymentFields(true);
});
...
function showHidePaymentMethodDiv() {
	showPaymentDetails = $('#whenPayment').find(':selected').val();
	if(showPaymentDetails == 'false') {
