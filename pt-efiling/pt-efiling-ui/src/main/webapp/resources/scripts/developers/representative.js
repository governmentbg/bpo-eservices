...
Representative.nav =
{
    ...
    importFromEarlierApp: "importRepresentativesFromEarlierApp.htm",
...
Representative.ajax =
{
    ...
    importFromEarlierApp: function(){
        $.ajax(
            {
                url:Representative.nav.importFromEarlierApp,
                type:"POST",
                async: false,
                success:function (html)
                {
...
$("#importRepresentativesFromEarlierApp").live("click", function() {
    Representative.ajax.importFromEarlierApp();
});
