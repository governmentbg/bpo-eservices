...
<section class="signature" id="signature">
    ...
    <header>
        ...
        <h2>
            <spring:message code="signature.title"/><span class="requiredTag">*</span>
        </h2>
    </header>
	<component:generic path="formWarnings" checkRender="false">
			...
			<c:if test="${!empty errors}">
		       	<div id="customWarningMessage" class="hidden">${errors}</div>
		    </c:if>		    
	    </component:generic>	    
	    ...
	    <component:generic path="formMessages" checkRender="true">
			...
			<c:if test="${!empty errors}">
		       	<p class="flMessageError permanentMessage" id="${path}ErrorMessageServer">${errors}</p>
		    </c:if>		    
	    </component:generic>
