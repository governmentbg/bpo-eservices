...
<tr>
    <td>
        ...
        <div id="collapseInventor${param.id}" class="collapse">
            <div>
    ...
    <td>
        <a role="button" style="margin-right: 10px"
           data-toggle="collapse" href="#collapseInventor${param.id}" aria-expanded="false"
           aria-controls="collapseInventor${param.id}"><spring:message code="person.matches.action.info"/></a>
        <a data-val="${param.id}" class="importInventorFromMatches btn btn-default">
