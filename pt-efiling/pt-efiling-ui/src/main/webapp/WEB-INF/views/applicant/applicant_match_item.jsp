...
<tr>
    <td>
        ...
        <div id="collapseApplicant${param.id}" class="collapse">
            <div>
    ...
    <td>
        <a role="button" style="margin-right: 10px"
           data-toggle="collapse" href="#collapseApplicant${param.id}" aria-expanded="false"
           aria-controls="collapseApplicant${param.id}"><spring:message code="person.matches.action.info"/></a>
        <a data-val="${param.id}" class="importApplicantFromMatches btn btn-default">
