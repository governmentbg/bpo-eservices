...
<div class="flBox clear">
    <div class="flFormRow alignCenter" id="wizard_correct_browser_version">
		...
		<span class="flField w17m" style="display:none;">
    ...
    <%--<div data-tooltip="help" class="hidden">--%>
        ...
        <%--<component:helpMessage textCode="First help tag" />--%>
    <%--</div>--%>
    <%--<br>--%>
    <%--<div class="tooltip-simple-text">--%>
        <%--<ul>--%>
            <%--<li>--%>
                <%--<component:helpMessage textCode="Second help tag"/>--%>
            <%--</li>--%>
        <%--</ul>--%>
    <%--</div>--%>
    <%--<br>--%>
    <%--<div class="tip"><i class="icon-info-sign"></i><component:helpMessage textCode="Third help tag"/></div>--%>
