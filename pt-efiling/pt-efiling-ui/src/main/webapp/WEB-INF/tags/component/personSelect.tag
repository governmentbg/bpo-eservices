...
<tags:render flowModeId="${flowModeId}" sectionId="${sectionId}" field="${path}" checkRender="${checkRender}">
    <div class="${divClass}">
        <component:select items="${items}" itemLabel="${itemLabel}" itemValue="${itemValue}" itemFilter="${itemFilter}" path="${path}" id="${id}" checkRender="${checkRender}" formTagClass="${formTagClass}"
