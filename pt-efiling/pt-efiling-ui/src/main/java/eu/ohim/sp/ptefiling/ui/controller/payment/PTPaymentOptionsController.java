 ...
 */
@Controller
public class PTPaymentOptionsController {
     ...
     * @return
     */
    @RequestMapping(value = "getPTPaymentOptions", method = RequestMethod.GET)
    public ModelAndView loadPayerTypes(@ModelAttribute PTFlowBeanImpl fb, BindingResult result) {
     ...
     * @param fb
     */
	private void setRepresentativeAsPayer(PaymentForm fbPaymentForm, PTFlowBeanImpl fb) {
	 ...
	 * @param fb
	 */
	private void setApplicantAsPayer(PaymentForm fbPaymentForm, PTFlowBeanImpl fb) {
     ...
     * @param fb
     */
    private void setOtherAsPayer(PaymentForm fbPaymentForm, PTFlowBeanImpl fb) {
