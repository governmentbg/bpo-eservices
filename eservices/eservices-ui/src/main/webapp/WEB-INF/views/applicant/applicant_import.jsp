...
<header>
    ...
    <h3><spring:message code="${flowModeId}.applicant.form.title"/></h3>
</header>
...
<%--
<sec:accesscontrollist var="security_applicant_import" hasPermission="Applicant_Import" domainObject="${flowModeId}"/>
<sec:accesscontrollist var="security_applicant_search" hasPermission="Applicant_Search" domainObject="${flowModeId}"/>
 --%>
