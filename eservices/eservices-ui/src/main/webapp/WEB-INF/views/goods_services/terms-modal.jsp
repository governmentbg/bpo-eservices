...
<div class="modal-content">
    ...
    <footer>
        <ul>
            ...
            <li><button class="SaveAndClose" data-dismiss="modal"><spring:message code="gs.import.button.done" /></button></li>
        </ul>
    </footer>
</div>
</div>
...
<div class="modal-content">
	...
	<section class="modal-gands-body">
        <div class="delay-warning"><component:helpMessage textCode="goods.services.take.longer.help"/></div>
        <h2><spring:message code="gs.providelist.label.choose" />:</h2>
        <div class="nice-classes" data-toggle="buttons-radio">
			<c:forEach begin="1" end="${numberOfClasses}" var="classHeading">
	            <button type="button" class="btn">${classHeading}</button>
	        </c:forEach>
	        <button type="button" class="hiddenButton">0</button>
	        <br />
	        <%--<a class="unknown-class"><spring:message code="gs.providelist.unknowClass" /></a>--%>
        </div>
		<h3 class="hideOnClear hide"><spring:message code="gs.providelist.label.terms" /> <span class="class-number"></span><span class="requiredTag">*</span></h3>
