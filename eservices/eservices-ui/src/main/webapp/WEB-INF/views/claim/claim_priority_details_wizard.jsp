...
<div class="addbox claimFields">
    <form:form modelAttribute="priorityForm" id="priorityForm" cssClass="fileUploadForm formEF">
        ...
        <sec:accesscontrollist var="security_priority_import" hasPermission="Priority_Import" domainObject="${flowModeId}"/>
        <!-- fix also import tag for the security check -->
        <sec:accesscontrollist var="security_priority_search" hasPermission="Priority_Search" domainObject="${flowModeId}"/>
