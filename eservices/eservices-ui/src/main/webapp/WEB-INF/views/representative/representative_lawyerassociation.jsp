...
<jsp:include page="/WEB-INF/views/representative/representative_choosetype.jsp"/>
	 <form:form id="representativeLawyerAssociationForm" cssClass="formEF"
           modelAttribute="representativeLawyerAssociationForm">

    <c:set var="imported" value="${representativeLawyerAssociationForm.imported}" scope="request"/>
    <c:set var="sectionId" value="representative_lawyerassociation" scope="request"/>
    ...
    <input type="hidden" class="reptypehidden" value="${representativeLawyerAssociationForm.type}"/>
    ...
    <component:generic path="correspondenceAddresses" checkRender="false">
        ...
        <jsp:include page="/WEB-INF/views/partials/correspondenceAddress.jsp">
            ...
            <jsp:param name="itemFilterValue" value="isRepresentative"/>
            <jsp:param name="size" value="${representativeLawyerAssociationForm.correspondenceAddresses.size()}"/>
        </jsp:include>
    </component:generic>
    ...
    <jsp:include page="/WEB-INF/views/partials/contactdetails.jsp"/>
         ...
         <div id="fileDocumentAttachment" class="fileuploadInfo collectiveSelectors">
             <component:file pathFilename="representativeAttachment" fileWrapperPath="representativeAttachment" labelCode="representative.legalEntity.field.attachment"
                             fileWrapper="${representativeLawyerAssociationForm.representativeAttachment}"/>
         </div>
	...
	<ul class="controls">
			...
			<li>
				<button class="addRepresentative addRepresentativeLawyerAssociation" type="button">
                <i class="add-icon"/>
