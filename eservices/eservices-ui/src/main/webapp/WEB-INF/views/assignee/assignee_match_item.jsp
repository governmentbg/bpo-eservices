...
<tr>
    <td>
        ...
        <div id="collapseAssignee${param.id}" class="collapse">
            <div>
    ...
    <td>
        <a role="button" style="margin-right: 10px"
           data-toggle="collapse" href="#collapseAssignee${param.id}" aria-expanded="false"
           aria-controls="collapseAssignee${param.id}"><spring:message code="person.matches.action.info"/></a>
        <a data-val="${param.id}" class="importAssigneeFromMatches btn btn-default">
