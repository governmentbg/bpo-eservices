...
<c:if test="${not empty sections_list}">
	<c:forEach var="section_item" items="${sections_list}">
		<sec:accesscontrollist var="security_priority"
			hasPermission="Priority_Add" domainObject="${flowModeId}" />
		<sec:accesscontrollist var="security_seniority"
			hasPermission="Seniority_Add" domainObject="${flowModeId}" />
		<sec:accesscontrollist var="security_exhibition"
			hasPermission="Exhibition_Priority_Add" domainObject="${flowModeId}" />
		<sec:accesscontrollist var="security_transformation"
			hasPermission="Transformation_Add" domainObject="${flowModeId}" />
		<c:if
