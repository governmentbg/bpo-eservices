...
<spring:eval var="office_code" expression="@propertyConfigurer.getProperty('sp.office')"/>
    	...
    	<div id="newFormDetails">
            <component:import
                    ...
                    autocompleteUrl="autocompleteDesign.htm"
                    ...
                    importButtonClass="btn importDS" component="general"
            ...
            <button type="button" id="createManualDetails" class="create-manually-button">
                ...
                <spring:message code="ds.details.button.addManually"/>
            </button>
            </c:if>
            <button type="button" class="import-button" id="searchForDesignBtn" data-ask="${configurationServiceDelegator.getValueFromGeneralComponent("service.designview.search.url")}">
            	<spring:message code="ds.details.button.dsView"/>
            </button>
            
            
            <div class="tip"><spring:message code="design.field.footerImport"/></div>
