    ...
    <form:form id="ptDetailsForm" cssClass="formEF" modelAttribute="patentDetailsForm">
        ...
        <div style="display: block">
            <div class="inline-fields half_pct">
                <component:input path="applicationNumber" labelTextCode="patent.form.field.applicationNumber" formTagClass="onerow-fields" checkRender="true"/>
            </div>
            <div class="right-fields">
                <component:input path="applicationDate" labelTextCode="patent.form.field.applicationDate" formTagClass="onerow-fields" checkRender="true"/>
            </div>
        </div>
        <div style="display: block">
            <div class="inline-fields half_pct">
                <component:input path="registrationNumber" labelTextCode="patent.form.field.registrationNumber" formTagClass="onerow-fields" checkRender="true"/>
            </div>
            <div class="right-fields">
                <component:input path="registrationDate" labelTextCode="patent.form.field.registrationDate" formTagClass="onerow-fields" checkRender="true"/>
            </div>
        </div>

        <div style="display: block">
            <div class="inline-fields half_pct">
                <component:input path="patentCurrentStatus" labelTextCode="patent.form.field.patentCurrentStatus" formTagClass="onerow-fields" checkRender="true"/>
            </div>
            <div class="right-fields">
                <component:input path="patentCurrentStatusDate" labelTextCode="patent.form.field.patentCurrentStatusDate" formTagClass="onerow-fields" checkRender="true"/>
            </div>
        </div>

        <component:textarea path="patentTitle" labelTextCode="patent.form.field.patentTitle" formTagClass="description-textarea" checkRender="true"></component:textarea>

        <component:textarea path="patentTitleSecondLang" labelTextCode="patent.form.field.patentTitleSecondLang" formTagClass="description-textarea"  checkRender="true"></component:textarea>

        <component:textarea path="patentAbstract" labelTextCode="patent.form.field.patentAbstract" formTagClass="description-textarea" checkRender="true" ></component:textarea>

        <component:textarea path="patentAbstractSecondLang" labelTextCode="patent.form.field.patentAbstractSecondLang" formTagClass="description-textarea" checkRender="true"></component:textarea>


        <hr>
        <c:choose>
            <c:when test="${fn:contains(flowModeId, 'pt-')}">
                <h3><spring:message code="patent.form.owners.title"></spring:message></h3>
            </c:when>
            <c:otherwise>
                <h3><spring:message code="ep_um.form.owners.title"></spring:message></h3>
            </c:otherwise>
        </c:choose>
        ...
        <c:if test="${imported}">
            ...
            <hr>
            <h3><spring:message code="form.inventors.title"></spring:message></h3>
            ...
            <c:forEach var="inventor" items="${patentDetailsForm.inventors}" varStatus="inv">
                ...
                <form:hidden id="inventors[${i}].nationalOfficialBusinessRegister" path="inventors[${i}].nationalOfficialBusinessRegister" />
                <form:hidden id="inventors[${i}].nationality" path="inventors[${i}].nationality" />
                <c:set var="i" value="${i+1}" />
            </c:forEach>
        </c:if>
    </form:form>
