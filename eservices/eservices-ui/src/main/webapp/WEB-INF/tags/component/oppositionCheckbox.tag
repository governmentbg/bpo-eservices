...
<jsp:directive.attribute name="labelTextCode" required="true" type="java.lang.String"
...
<tags:render flowModeId="${flowModeId}" sectionId="${sectionId}" field="${path}" checkRender="${checkRender}">
    ...
    <c:if test="${not empty labelTextCode}">
        <label class="${labelClass}" for="${id}">
            <form:checkbox dir="exclusive: ${exclusivity}" path="${path}" id="${id}" value="${value}" cssClass="${formTagClass}" onclick="${onclick}('${id}')" disabled="${!fieldIsEditable}"/>
