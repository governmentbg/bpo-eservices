...
public class DesignerServiceMock {
	...
	public static DesignerForm getDesigner(String id,String lang){
			...
			form.setMiddleName("perez");
			form.setPartOfEEA(true);
			form.setWebsite("www.test.com");
			form.setWaiver(false);
			form.setSurname("garcia");
