 ...
 * * * . _ . *
 ******************************************************************************/
package eu.ohim.sp.common.ui.service.constant;
...
public class AppConstants {
    ...
    public static final String MarkShape = "shapemark";
    public static final String MarkHologram = "hologrammark";
    public static final String MarkPosition = "positionmark";
    public static final String MarkMotion = "motionmark";
    public static final String MarkPattern = "patternmark";
    public static final String MarkMultimedia = "multimediamark";
    public static final String GeoIndication = "geoindication";
