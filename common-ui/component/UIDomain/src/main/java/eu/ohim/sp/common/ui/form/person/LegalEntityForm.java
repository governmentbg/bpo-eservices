 ...
 * 
 */
public class LegalEntityForm extends ApplicantForm implements Cloneable {
	...
	public LegalEntityForm() {
		setType(ApplicantKindForm.LEGAL_ENTITY);
	}
	 ...
	 */
	@Override
	public LegalEntityForm clone() throws CloneNotSupportedException{
		LegalEntityForm legalEntityForm = copyApp(LegalEntityForm.class);
		legalEntityForm.setType(ApplicantKindForm.LEGAL_ENTITY);
	...
	public AvailableSection getAvailableSectionName() {
		return AvailableSection.APPLICANT_LEGALENTITY;
	}
    ...
    public boolean equals(Object o)
    {
        ...
        if (!(o instanceof LegalEntityForm)) {
			return false;
		}
        if (!super.equals(o)) {
			return false;
        ...
        LegalEntityForm that = (LegalEntityForm) o;
