 ...
 * 
 */
public class AssigneeLegalEntityForm extends AssigneeForm implements Cloneable {
	...
	public AssigneeLegalEntityForm() {
		setType(AssigneeKindForm.LEGAL_ENTITY);
	}
	 ...
	 */
	@Override
	public AssigneeLegalEntityForm clone() throws CloneNotSupportedException{
		AssigneeLegalEntityForm legalEntityForm = copyAss(AssigneeLegalEntityForm.class);
	...
	public AvailableSection getAvailableSectionName() {
		return AvailableSection.ASSIGNEE_LEGALENTITY;
	}
    ...
    public boolean equals(Object o)
    {
        ...
        if (!(o instanceof AssigneeLegalEntityForm)) {
			return false;
		}
        if (!super.equals(o)) {
			return false;
        ...
        AssigneeLegalEntityForm that = (AssigneeLegalEntityForm) o;
