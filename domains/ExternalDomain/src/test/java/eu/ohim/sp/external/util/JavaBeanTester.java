 ...
 *  * * . _ . *
 */
package eu.ohim.sp.external.util;

import eu.ohim.sp.external.domain.common.CharacterSet;
import eu.ohim.sp.external.domain.epayment.CardKindCode;
...
public class JavaBeanTester {
    ...
    private static Object buildValue(Class<?> clazz) throws InstantiationException, IllegalAccessException,
        ...
        if (clazz == String.class)
        ...
        } else if (clazz == PersonRoleRelationKind.class) {
            return PersonRoleRelationKind.ASSOCIATION;
        } else if (clazz == Gender.class) {
            return Gender.MALE;
        } else if (clazz == CharacterSet.class) {
            return CharacterSet.GEORGIAN;
            ...
            return PaymentStatusCode.ATTACHED;
        }else if (clazz == OperationCodeType.class) {
            return OperationCodeType.INSERT;
        }
        else {
