...
public class MimeTypes {
	...
	public static final String MIME_APPLICATION_VND_OPENXMLFORMAT_MSPOWERPOINT = "application/vnd.openxmlformats-officedocument.presentationml.presentation";
	public static final String MIME_APPLICATION_VND_OPENXMLFORMAT_MSEXCEL = "application/vnd.openxmlformats-officedocument.spreadsheetml.sheet";
	public static final String MIME_APPLICATION_VND_OPENXMLFORMAT_MSWORD = "application/vnd.openxmlformats-officedocument.wordprocessingml.document";
    ...
    static {
        mimeTypeMapping = new HashMap<String, String>(200) {
...

            {
				...
				put1("pptx", MIME_APPLICATION_VND_OPENXMLFORMAT_MSPOWERPOINT);
				put1("xlsx", MIME_APPLICATION_VND_OPENXMLFORMAT_MSEXCEL);
				put1("docx", MIME_APPLICATION_VND_OPENXMLFORMAT_MSWORD);
            }
        };

        extensionMapping = new HashMap<String, String>(200) {
            private void put1(String key, String value) {
                if (put(key, value) != null)
                    throw new IllegalArgumentException("Duplicated extension: " + key);
            }
     ...
     * If no MIME type was found it returns 'application/octet-stream' type.
     */
    public static String getExtension(String mymetype) {
        String mimeType = extensionMapping.get(mymetype.toLowerCase());
