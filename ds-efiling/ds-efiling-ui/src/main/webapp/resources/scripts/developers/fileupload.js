...
$(".fileinput-button:not(.disabled) .uploadInput").live("click", function () {
    ...
    $(this).fileupload({
        ...
        fileInput:$(this),
			...
			//updateDesignViewGrid(parentHolder);
...
$('.toBeRemovedFile:not(.disabled)').live("click", function () {
    ...
    var idValue = $(this).find("span").attr("data-documentId"); // $(this).parents("form").find(".idFileuploadForm").attr("value");
    var id = "documentId=" + idValue;
    var fileWrapper = id + "";
