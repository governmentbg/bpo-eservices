...
function anyFormsOpen()
{
    return isFormOpen("#tabApplicant")
           ...
           || isFormOpen("#tabDesigner")           
           || isFormOpen("#addDesignForm")
           || isFormOpen("#divisionalApplicationTabForm");    
}
...
function createFormsOpenText()
{
    ...
    if(isFormOpen("#tabDesigner")) {
        text += $("#openDesignerFormMessage").html();
    }
    if(isFormOpen("#addDesignForm")) {
        text += $("#openDesignsFormMessage").html();
    }
    if (isFormOpen("#divisionalApplicationTabForm")) {
    	text += $("#openDivisionalApplicationFormMessage").html();
    }
