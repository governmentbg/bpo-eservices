...
<tags:render flowModeId="${flowModeId}" sectionId="${sectionId}" field="view" checkRender="true">
    ...
    <span id="editMultiupload" class="hide">
        <c:if test="${not empty flowBean.designViews}">
            <c:forEach items="${flowBean.designViews}" var="form">
                ...
                <inputmock data-sequence="${sequence}" class="form" name="description" value="<c:out value="${form.description}" escapeXml="true" />"></inputmock>
                <inputmock data-sequence="${sequence}" class="form" name="publishInColour"  value="<c:out value="${form.publishInColour}" escapeXml="true" />"></inputmock>
                <inputmock data-sequence="${sequence}" class="form" name="publishInBlackWhite" value="<c:out value="${form.publishInBlackWhite}" escapeXml="true" />"></inputmock>
                <inputmock data-sequence="${sequence}" class="form" name="publicationSize" value="${form.publicationSize}"></inputmock>
                <inputmock data-sequence="${sequence}" class="form" name="type" value="<c:out value="${form.type}" escapeXml="true" />"></inputmock>
