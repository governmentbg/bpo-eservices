...
<header>
	<h1>
		<spring:message code="design.form.view.title" />
	</h1>
...
<section class="modal-body modal-design-view">
 	...
 	<form:form id="addNewDesignViewForm" cssClass="formEF form-design-view" modelAttribute="designViewForm">
 		<c:set var="sectionId" value="designViews" scope="request" />
		<c:set var="storedFile" value="${designViewForm.view.storedFiles[0]}" />
		
		<div>
			<label><spring:message code="design.form.view.modal.field.view" /></label>
			<div>
		...
		<component:generic path="description" checkRender="true">   
    		<label for="viewDescription"><spring:message code="design.form.view.modal.field.description" /></label>
			<form:textarea path="description" id="viewDescription" cssClass="design-view-textarea" disabled="true" />
    	</component:generic>
    	...
    	<component:generic path="publishInColour" checkRender="true">
    		<label for="publishInColour">
    			...
    			<span><spring:message code="design.form.view.modal.field.publishInColour" /></span>
    		</label>
    	</component:generic>
    	...
    	<component:generic path="publishInBlackWhite" checkRender="true">
    		<label for="publishInBlackWhite">
    			...
    			<span><spring:message code="design.form.view.modal.field.publishInBlackAndWhite" /></span>
    		</label>
    	</component:generic>
		    	
		<component:generic path="publicationSize" checkRender="true">
			<label for="publicationSize"><spring:message code="design.form.view.modal.field.publicationSize" /></label>
		...
		<component:generic path="type" checkRender="true">
			<label for="type"><spring:message code="design.form.view.modal.field.type" /></label>
