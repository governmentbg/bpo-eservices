...
<div id="applicationCACardList">
    ...
    <c:if test="${not empty flowBean.mainForm.correspondanceAddresses}">
        ...
        <table id="addedApplicationCAs" class="table">
            ...
            <c:forEach var="applicationCA" items="${flowBean.mainForm.correspondanceAddresses}" varStatus="applicationCAId">
                <c:set var="i" value="${i+1}"/>
                <tr id="applicationCA_id_${applicationCA.id}">                
                    <jsp:include page="/WEB-INF/views/review/applicationCA_card.jsp">
