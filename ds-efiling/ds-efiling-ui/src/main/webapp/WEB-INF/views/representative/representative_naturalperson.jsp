...
<form:form id="representativeNaturalPersonForm" modelAttribute="representativeNaturalPersonForm" cssClass="formEF">
	...
	<div id="representativeAttachment" class="fileuploadInfo collectiveSelectors">
		<component:file labelCode="representative.naturalPerson.field.powerofAttorney" pathFilename="filePowerOfAttorney" 
					fileWrapperPath="representativeAttachment"
					fileWrapper="${representativeNaturalPersonForm.representativeAttachment}"
					showPreLabelInputFileButton="false"
					inputFileClass="views-upload-btn"/>
   	</div>
