...
<jsp:directive.attribute name="node" required="true" type="eu.ohim.sp.common.ui.form.classification.TaxonomyConceptNodeTreeView" description="The node to be represented in the node" />
