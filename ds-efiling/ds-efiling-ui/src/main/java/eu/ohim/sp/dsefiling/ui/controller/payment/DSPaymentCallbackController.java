 ...
 */
@Controller
public class DSPaymentCallbackController {

    /** Logger for this class and subclasses */
    private static final Logger LOGGER = Logger.getLogger(DSPaymentCallbackController.class);
    ...
    public ModelAndView paymentCallback(HttpServletRequest request,
        ...
        designApplication.setApplicationFilingNumber(applicationFilingNumber);
        PaymentResult paymentResult = paymentService.notifyPaymentResult(office, module, designApplication, paymentPlatformData);
