...
insert into DSETTINGVALUE (IdValue, TxtValue, IdConfigSetting, DtCreated) values (37, '${sp.services.config.dir}/drl/applicant.drl',  (select IdParam from PCONFIGPARAM where NmParam = 'applicant.drl'), ${valid.from});
...
insert into DSETTINGVALUE (IdValue, TxtValue, IdConfigSetting, DtCreated) values (38, '${sp.services.config.dir}/drl/trademark.drl', (select IdParam from PCONFIGPARAM where NmParam = 'trademark.drl'), ${valid.from});
...
insert into DSETTINGVALUE (IdValue, TxtValue, IdConfigSetting, DtCreated) values (39, '${sp.services.config.dir}/drl/claim.drl', (select IdParam from PCONFIGPARAM where NmParam = 'claim.drl'), ${valid.from});
...
insert into DSETTINGVALUE (IdValue, TxtValue, IdConfigSetting, DtCreated) values (40, '${sp.services.config.dir}/drl/representative.drl', (select IdParam from PCONFIGPARAM where NmParam = 'representative.drl'), ${valid.from});
...
insert into DSETTINGVALUE (IdValue, TxtValue, IdConfigSetting, DtCreated) values (41, '${sp.services.config.dir}/drl/fees.drl', (select IdParam from PCONFIGPARAM where NmParam = 'fees.drl'), ${valid.from});
...
insert into DSETTINGVALUE (IdValue, TxtValue, IdConfigSetting, DtCreated) values (42, '${sp.services.config.dir}/drl/sections.drl', (select IdParam from PCONFIGPARAM where NmParam = 'sections.drl'), ${valid.from});
...
insert into DSETTINGVALUE (IdValue, TxtValue, IdConfigSetting, DtCreated) values (43, '${sp.services.config.dir}/drl/languages.drl', (select IdParam from PCONFIGPARAM where NmParam = 'languages.drl'), ${valid.from});
...
insert into DSETTINGVALUE (IdValue, TxtValue, IdConfigSetting, DtCreated) values (44, '${sp.services.config.dir}/drl/registrationNumber.drl', (select IdParam from PCONFIGPARAM where NmParam = 'registrationNumber.drl'), ${valid.from});
...
insert into DSETTINGVALUE (IdValue, TxtValue, IdConfigSetting, DtCreated) values (45, '${sp.services.config.dir}/drl/goodsandservices.drl', (select IdParam from PCONFIGPARAM where NmParam = 'goodsandservices.drl'), ${valid.from});
...
insert into DSETTINGVALUE (IdValue, TxtValue, IdConfigSetting, DtCreated) values (46, '${sp.services.config.dir}/drl/functions.drl', (select IdParam from PCONFIGPARAM where NmParam = 'functions.drl'), ${valid.from});
...
insert into DSETTINGVALUE (IdValue, TxtValue, IdConfigSetting, DtCreated) values (47, '${sp.services.config.dir}/drl/identifierCreator.drl', (select IdParam from PCONFIGPARAM where NmParam = 'identifierCreator.drl'), ${valid.from});
...
insert into DSETTINGVALUE (IdValue, TxtValue, IdConfigSetting, DtCreated) values (48, '${sp.services.config.dir}/drl/payment.drl', (select IdParam from PCONFIGPARAM where NmParam = 'payment.drl'), ${valid.from});
...
insert into DSETTINGVALUE (IdValue, TxtValue, IdConfigSetting, DtCreated) values (49, '${sp.services.config.dir}/drl/otherAttachments.drl', (select IdParam from PCONFIGPARAM where NmParam = 'otherAttachments.drl'), ${valid.from});
...
insert into DSETTINGVALUE (IdValue, TxtValue, IdConfigSetting, DtCreated) values (50, '${sp.services.config.dir}/drl/signature.drl', (select IdParam from PCONFIGPARAM where NmParam = 'signature.drl'), ${valid.from});
...
insert into DSETTINGVALUE (IdValue, TxtValue, IdConfigSetting, DtCreated) values (76, '${sp.services.config.dir}/conf/oneform-conf.xml', (select IdParam from PCONFIGPARAM where NmParam = 'oneform-conf'), ${valid.from});
...
insert into DSETTINGVALUE (IdValue, TxtValue, IdConfigSetting, DtCreated) values (77, '${sp.services.config.dir}/conf/oneform-flow.xml', (select IdParam from PCONFIGPARAM where NmParam = 'oneform'), ${valid.from});
...
insert into DSETTINGVALUE (IdValue, TxtValue, IdConfigSetting, DtCreated) values (78, '${sp.services.config.dir}/conf/wizard-conf.xml', (select IdParam from PCONFIGPARAM where NmParam = 'wizard-conf'), ${valid.from});
...
insert into DSETTINGVALUE (IdValue, TxtValue, IdConfigSetting, DtCreated) values (79, '${sp.services.config.dir}/conf/wizard-flow.xml', (select IdParam from PCONFIGPARAM where NmParam = 'wizard'), ${valid.from});
...
insert into DSETTINGVALUE (IdValue, TxtValue, IdConfigSetting, DtCreated) values (80, '${sp.services.config.dir}/conf/tm-efiling-conf.xml', (select IdParam from PCONFIGPARAM where NmParam = 'tm-efiling-conf'), ${valid.from});
...
insert into DSETTINGVALUE (IdValue, TxtValue, IdConfigSetting, DtCreated) values (81, '${sp.services.config.dir}/conf/tm-efiling-flow.xml', (select IdParam from PCONFIGPARAM where NmParam = 'tm-efiling'), ${valid.from});
...
insert into DSETTINGVALUE (IdValue, TxtValue, IdConfigSetting, DtCreated) values (85, '${sp.services.config.dir}/conf/repository.xml', (select IdParam from PCONFIGPARAM where NmParam = 'repository'), ${valid.from});
...
insert into DSETTINGVALUE (IdValue, TxtValue, IdConfigSetting, DtCreated) values (86, '${sp.services.config.dir}/conf/fileUploadConfiguration.xml', (select IdParam from PCONFIGPARAM where NmParam = 'fileUploadConfiguration'), ${valid.from});
...
insert into DSETTINGVALUE (IdValue, TxtValue, IdConfigSetting, DtCreated) values (87, '${sp.services.config.dir}/conf/countries.xml', (select IdParam from PCONFIGPARAM where NmParam = 'country-config'), ${valid.from});
...
insert into DSETTINGVALUE (IdValue, TxtValue, IdConfigSetting, DtCreated) values (88, '${sp.services.config.dir}/conf/nationalities.xml', (select IdParam from PCONFIGPARAM where NmParam = 'nationality-config'), ${valid.from});
...
insert into DSETTINGVALUE (IdValue, TxtValue, IdConfigSetting, DtCreated) values (89, '${sp.services.config.dir}/conf/states.xml', (select IdParam from PCONFIGPARAM where NmParam = 'states-config'), ${valid.from});
...
insert into DSETTINGVALUE (IdValue, TxtValue, IdConfigSetting, DtCreated) values (90, '${sp.services.config.dir}/conf/first-lang.xml', (select IdParam from PCONFIGPARAM where NmParam = 'first-lang-conf'), ${valid.from});
...
insert into DSETTINGVALUE (IdValue, TxtValue, IdConfigSetting, DtCreated) values (91, '${sp.services.config.dir}/conf/second-lang.xml', (select IdParam from PCONFIGPARAM where NmParam = 'second-lang-conf'), ${valid.from});
...
insert into DSETTINGVALUE (IdValue, TxtValue, IdConfigSetting, DtCreated) values (92, '${sp.services.config.dir}/conf/permissions.xml', (select IdParam from PCONFIGPARAM where NmParam = 'mapping-roles'), ${valid.from});
...
insert into DSETTINGVALUE (IdValue, TxtValue, IdConfigSetting, DtCreated) values (93, '${sp.services.config.dir}/conf/service-enabled.xml', (select IdParam from PCONFIGPARAM where NmParam = 'enabled-services'), ${valid.from});
...
insert into DSETTINGVALUE (IdValue, TxtValue, IdConfigSetting, DtCreated) values (94, '${sp.services.config.dir}/conf/colour-configuration.xml', (select IdParam from PCONFIGPARAM where NmParam = 'colour-configuration'), ${valid.from});
...
insert into DSETTINGVALUE (IdValue, TxtValue, IdConfigSetting, DtCreated) values (95, '${sp.services.config.dir}/conf/regex-configuration.xml', (select IdParam from PCONFIGPARAM where NmParam = 'regex-configuration'), ${valid.from});
...
insert into DSETTINGVALUE (IdValue, TxtValue, IdConfigSetting, DtCreated) values (96, '${sp.services.config.dir}/conf/seniorityNature.xml', (select IdParam from PCONFIGPARAM where NmParam = 'seniority-natures'), ${valid.from});
...
insert into DSETTINGVALUE (IdValue, TxtValue, IdConfigSetting, DtCreated) values (97, '${sp.services.config.dir}/conf/exhibition.xml', (select IdParam from PCONFIGPARAM where NmParam = 'exhibitions'), ${valid.from});
...
insert into DSETTINGVALUE (IdValue, TxtValue, IdConfigSetting, DtCreated) values (98, '${sp.services.config.dir}/conf/paymentMethod.xml', (select IdParam from PCONFIGPARAM where NmParam = 'payment-methods'), ${valid.from});
...
insert into DSETTINGVALUE (IdValue, TxtValue, IdConfigSetting, DtCreated) values (99, '${sp.services.config.dir}/conf/payerType.xml', (select IdParam from PCONFIGPARAM where NmParam = 'payer-types'), ${valid.from});
...
insert into DSETTINGVALUE (IdValue, TxtValue, IdConfigSetting, DtCreated) values (100, '${sp.services.config.dir}/conf/receipt.rptdesign', (select IdParam from PCONFIGPARAM where NmParam = 'receipt'), ${valid.from});
...
insert into DSETTINGVALUE (IdValue, TxtValue, IdConfigSetting, DtCreated) values (101, '${sp.services.config.dir}/conf/similarTM.rptdesign', (select IdParam from PCONFIGPARAM where NmParam = 'similarTM'), ${valid.from});
...
insert into DSETTINGVALUE (IdValue, TxtValue, IdConfigSetting, DtCreated) values (102, '${sp.services.config.dir}/conf/mimetype', (select IdParam from PCONFIGPARAM where NmParam = 'mimetype'), ${valid.from});
...
insert into DSETTINGVALUE (IdValue, TxtValue, IdConfigSetting, DtCreated) values (103, '${sp.services.config.dir}/conf/container.xml', (select IdParam from PCONFIGPARAM where NmParam = 'container.xml'), ${valid.from});
...
insert into DSETTINGVALUE (IdValue, TxtValue, IdConfigSetting, DtCreated) values (104, 'false',  (select cp.IdParam from PCONFIGPARAM cp, CCOMPONENT c where cp.IdComponent = c.IdComponent and c.NmComponent='general' and cp.NmParam = 'service.applicant.details.urlEnabled'), ${valid.from});

-- Applicant Search URI
-- NOT USED in FI
-- insert into PCONFIGPARAM (IdParam, DscParam, IsHidden, NmParam, TyParam, IdComponent) values (88, 'Applicant details URI', 0, 'service.applicant.details.url', 0, (select IdComponent from CCOMPONENT c where c.NmComponent='general'));
...
insert into DSETTINGVALUE (IdValue, TxtValue, IdConfigSetting, DtCreated) values (107, 'false',  (select cp.IdParam from PCONFIGPARAM cp, CCOMPONENT c where cp.IdComponent = c.IdComponent and c.NmComponent='general' and cp.NmParam = 'service.representative.details.urlEnabled'), ${valid.from});

-- Representative Search URI
-- NOT USED in FI
-- insert into PCONFIGPARAM (IdParam, DscParam, IsHidden, NmParam, TyParam, IdComponent) values (91, 'Representative details URI', 0, 'service.representative.details.url', 0, (select IdComponent from CCOMPONENT c where c.NmComponent='general'), 0);;
...
insert into DSETTINGVALUE (IdValue, TxtValue, IdConfigSetting, DtCreated) values (118, '22000',  (select cp.IdParam from PCONFIGPARAM cp, CCOMPONENT c where cp.IdComponent = c.IdComponent and c.NmComponent='general' and cp.NmParam = 'tmefiling.product.code'), ${valid.from});
...
insert into DSETTINGVALUE (IdValue, TxtValue, IdConfigSetting, DtCreated) values (119, '${sp.services.config.dir}/conf/adapter.xml',  (select cp.IdParam from PCONFIGPARAM cp, CCOMPONENT c where cp.IdComponent = c.IdComponent and c.NmComponent='general' and cp.NmParam = 'service.adapters.list'), ${valid.from});
...
insert into DSETTINGVALUE (IdValue, TxtValue, IdConfigSetting, DtCreated) values (124, '0',  (select cp.IdParam from PCONFIGPARAM cp, CCOMPONENT c where cp.IdComponent = c.IdComponent and c.NmComponent='general' and cp.NmParam = 'claim.seniority.add.maxNumber'), ${valid.from});
...
insert into DSETTINGVALUE (IdValue, TxtValue, IdConfigSetting, DtCreated) values (126, '1000',  (select cp.IdParam from PCONFIGPARAM cp, CCOMPONENT c where cp.IdComponent = c.IdComponent and c.NmComponent='general' and cp.NmParam = 'claim.exhibition.add.maxNumber'), ${valid.from});
...
insert into DSETTINGVALUE (IdValue, TxtValue, IdConfigSetting, DtCreated) values (130, '${sp.services.config.dir}/conf/fees-configuration.xml', (select IdParam from PCONFIGPARAM where NmParam = 'fees-configuration'), ${valid.from});
