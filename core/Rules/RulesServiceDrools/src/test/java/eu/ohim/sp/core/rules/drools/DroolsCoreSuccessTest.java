...
public class DroolsCoreSuccessTest {
    ...
    public void testValidate_Ok() {
        ...
        ErrorList errors = droolsCore.fireRulesValidate(MODULE, VALIDATE_SET, objects);
        Assert.assertEquals(errors.getErrorList().size(), 0);
    }

    // @Test
    public void testValidateWithErrors() {
        // Sets specific information
    ...
    public void testCalculate_Ok() {
        ...
        boolean result = droolsCore.fireRulesCalculate(MODULE, CALCULATE_SET, objects);
        Assert.assertTrue(result);
    }

    @Test
    public void testCalculateWithErrors() {
        Collection<Object> objects = new ArrayList<Object>();
        Fee fee = new Fee();
    ...
    private void initConfiguration() {
        ...
        List<String> tmValidateRuleListDrls = new ArrayList<String>();
        tmValidateRuleListDrls.add(VALIDATE_DRL);
