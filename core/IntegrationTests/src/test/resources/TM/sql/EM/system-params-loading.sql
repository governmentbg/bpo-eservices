...
insert into PCONFIGPARAM (IdParam, DscParam, IsHidden, NmParam, PrmSource, TyParam, IdComponent) values (51, 'The rule list', 0, 'EF_rule_list', 0, 1, (select IdComponent from CCOMPONENT c where c.NmComponent='eu.ohim.sp.core.rules'));
insert into DCONFIGSETTING (IdConfigSetting, IdParam, LogModifiedBy, DtValidFrom, DtValidTo, DtCreated) values (51, (select cp.IdParam from PCONFIGPARAM cp, CCOMPONENT c where cp.IdComponent = c.IdComponent and cp.NmParam = 'EF_rule_list'), null, ${valid.from}, null, ${valid.from});
insert into DSETTINGVALUE (IdValue, TxtValue, IdConfigSetting, DtCreated) values (51, 'functions.drl',  (select IdParam from PCONFIGPARAM where NmParam = 'EF_rule_list'), ${valid.from});
insert into DSETTINGVALUE (IdValue, TxtValue, IdConfigSetting, DtCreated) values (52, 'fees.drl',  (select IdParam from PCONFIGPARAM where NmParam = 'EF_rule_list'), ${valid.from});
insert into DSETTINGVALUE (IdValue, TxtValue, IdConfigSetting, DtCreated) values (53, 'trademark.drl',  (select IdParam from PCONFIGPARAM where NmParam = 'EF_rule_list'), ${valid.from});
insert into DSETTINGVALUE (IdValue, TxtValue, IdConfigSetting, DtCreated) values (54, 'applicant.drl',  (select IdParam from PCONFIGPARAM where NmParam = 'EF_rule_list'), ${valid.from});
insert into DSETTINGVALUE (IdValue, TxtValue, IdConfigSetting, DtCreated) values (55, 'claim.drl',  (select IdParam from PCONFIGPARAM where NmParam = 'EF_rule_list'), ${valid.from});
insert into DSETTINGVALUE (IdValue, TxtValue, IdConfigSetting, DtCreated) values (56, 'representative.drl',  (select IdParam from PCONFIGPARAM where NmParam = 'EF_rule_list'), ${valid.from});
insert into DSETTINGVALUE (IdValue, TxtValue, IdConfigSetting, DtCreated) values (57, 'sections.drl',  (select IdParam from PCONFIGPARAM where NmParam = 'EF_rule_list'), ${valid.from});
insert into DSETTINGVALUE (IdValue, TxtValue, IdConfigSetting, DtCreated) values (58, 'languages.drl',  (select IdParam from PCONFIGPARAM where NmParam = 'EF_rule_list'), ${valid.from});
insert into DSETTINGVALUE (IdValue, TxtValue, IdConfigSetting, DtCreated) values (59, 'payment.drl',  (select IdParam from PCONFIGPARAM where NmParam = 'EF_rule_list'), ${valid.from});
insert into DSETTINGVALUE (IdValue, TxtValue, IdConfigSetting, DtCreated) values (60, 'signature.drl',  (select IdParam from PCONFIGPARAM where NmParam = 'EF_rule_list'), ${valid.from});

-- List of drl files pertaining to the registration number list parameter
insert into PCONFIGPARAM (IdParam, DscParam, IsHidden, NmParam, PrmSource, TyParam, IdComponent) values (52, 'The registration number list', 0, 'EF_registration_number_list', 0, 1, (select IdComponent from CCOMPONENT c where c.NmComponent='eu.ohim.sp.core.rules'));
insert into DCONFIGSETTING (IdConfigSetting, IdParam, LogModifiedBy, DtValidFrom, DtValidTo, DtCreated) values (52, (select cp.IdParam from PCONFIGPARAM cp, CCOMPONENT c where cp.IdComponent = c.IdComponent and cp.NmParam = 'EF_registration_number_list'), null, ${valid.from}, null, ${valid.from});
insert into DSETTINGVALUE (IdValue, TxtValue, IdConfigSetting, DtCreated) values (61, 'registrationNumber.drl',  (select IdParam from PCONFIGPARAM where NmParam = 'EF_registration_number_list'), ${valid.from});

-- List of drl files pertaining to the fee list parameter
insert into PCONFIGPARAM (IdParam, DscParam, IsHidden, NmParam, PrmSource, TyParam, IdComponent) values (53, 'The fee list', 0, 'EF_fee_list', 0, 1, (select IdComponent from CCOMPONENT c where c.NmComponent='eu.ohim.sp.core.rules'));
insert into DCONFIGSETTING (IdConfigSetting, IdParam, LogModifiedBy, DtValidFrom, DtValidTo, DtCreated) values (53, (select cp.IdParam from PCONFIGPARAM cp, CCOMPONENT c where cp.IdComponent = c.IdComponent and cp.NmParam = 'EF_fee_list'), null, ${valid.from}, null, ${valid.from});
insert into DSETTINGVALUE (IdValue, TxtValue, IdConfigSetting, DtCreated) values (62, 'fees.drl',  (select IdParam from PCONFIGPARAM where NmParam = 'EF_fee_list'), ${valid.from});

-- List of drl files pertaining to the goods and services list parameter
insert into PCONFIGPARAM (IdParam, DscParam, IsHidden, NmParam, PrmSource, TyParam, IdComponent) values (54, 'The goods and services list', 0, 'EF_goodsandservices_list', 0, 1, (select IdComponent from CCOMPONENT c where c.NmComponent='eu.ohim.sp.core.rules'));
insert into DCONFIGSETTING (IdConfigSetting, IdParam, LogModifiedBy, DtValidFrom, DtValidTo, DtCreated) values (54, (select cp.IdParam from PCONFIGPARAM cp, CCOMPONENT c where cp.IdComponent = c.IdComponent and cp.NmParam = 'EF_goodsandservices_list'), null, ${valid.from}, null, ${valid.from});
insert into DSETTINGVALUE (IdValue, TxtValue, IdConfigSetting, DtCreated) values (63, 'functions.drl',  (select IdParam from PCONFIGPARAM where NmParam = 'EF_goodsandservices_list'), ${valid.from});
insert into DSETTINGVALUE (IdValue, TxtValue, IdConfigSetting, DtCreated) values (64, 'goodsandservices.drl',  (select IdParam from PCONFIGPARAM where NmParam = 'EF_goodsandservices_list'), ${valid.from});

-- List of drl files pertaining to the applicant list parameter
insert into PCONFIGPARAM (IdParam, DscParam, IsHidden, NmParam, PrmSource, TyParam, IdComponent) values (55, 'The applicant list', 0, 'EF_applicant_list', 0, 1, (select IdComponent from CCOMPONENT c where c.NmComponent='eu.ohim.sp.core.rules'));
insert into DCONFIGSETTING (IdConfigSetting, IdParam, LogModifiedBy, DtValidFrom, DtValidTo, DtCreated) values (55, (select cp.IdParam from PCONFIGPARAM cp, CCOMPONENT c where cp.IdComponent = c.IdComponent and cp.NmParam = 'EF_applicant_list'), null, ${valid.from}, null, ${valid.from});
insert into DSETTINGVALUE (IdValue, TxtValue, IdConfigSetting, DtCreated) values (65, 'functions.drl',  (select IdParam from PCONFIGPARAM where NmParam = 'EF_applicant_list'), ${valid.from});
insert into DSETTINGVALUE (IdValue, TxtValue, IdConfigSetting, DtCreated) values (66, 'applicant.drl',  (select IdParam from PCONFIGPARAM where NmParam = 'EF_applicant_list'), ${valid.from});

-- List of drl files pertaining to the trademark list parameter
insert into PCONFIGPARAM (IdParam, DscParam, IsHidden, NmParam, PrmSource, TyParam, IdComponent) values (56, 'The trademark list', 0, 'EF_trademark_list', 0, 1, (select IdComponent from CCOMPONENT c where c.NmComponent='eu.ohim.sp.core.rules'));
insert into DCONFIGSETTING (IdConfigSetting, IdParam, LogModifiedBy, DtValidFrom, DtValidTo, DtCreated) values (56, (select cp.IdParam from PCONFIGPARAM cp, CCOMPONENT c where cp.IdComponent = c.IdComponent and cp.NmParam = 'EF_trademark_list'), null, ${valid.from}, null, ${valid.from});
insert into DSETTINGVALUE (IdValue, TxtValue, IdConfigSetting, DtCreated) values (67, 'functions.drl',  (select IdParam from PCONFIGPARAM where NmParam = 'EF_trademark_list'), ${valid.from});
insert into DSETTINGVALUE (IdValue, TxtValue, IdConfigSetting, DtCreated) values (68, 'trademark.drl',  (select IdParam from PCONFIGPARAM where NmParam = 'EF_trademark_list'), ${valid.from});

-- List of drl files pertaining to the claim list parameter
insert into PCONFIGPARAM (IdParam, DscParam, IsHidden, NmParam, PrmSource, TyParam, IdComponent) values (57, 'The claim list', 0, 'EF_claim_list', 0, 1, (select IdComponent from CCOMPONENT c where c.NmComponent='eu.ohim.sp.core.rules'));
insert into DCONFIGSETTING (IdConfigSetting, IdParam, LogModifiedBy, DtValidFrom, DtValidTo, DtCreated) values (57, (select cp.IdParam from PCONFIGPARAM cp, CCOMPONENT c where cp.IdComponent = c.IdComponent and cp.NmParam = 'EF_claim_list'), null, ${valid.from}, null, ${valid.from});
insert into DSETTINGVALUE (IdValue, TxtValue, IdConfigSetting, DtCreated) values (69, 'functions.drl',  (select IdParam from PCONFIGPARAM where NmParam = 'EF_claim_list'), ${valid.from});
insert into DSETTINGVALUE (IdValue, TxtValue, IdConfigSetting, DtCreated) values (70, 'claim.drl',  (select IdParam from PCONFIGPARAM where NmParam = 'EF_claim_list'), ${valid.from});

-- List of drl files pertaining to the representative list parameter
insert into PCONFIGPARAM (IdParam, DscParam, IsHidden, NmParam, PrmSource, TyParam, IdComponent) values (58, 'The representative list', 0, 'EF_representative_list', 0, 1, (select IdComponent from CCOMPONENT c where c.NmComponent='eu.ohim.sp.core.rules'));
insert into DCONFIGSETTING (IdConfigSetting, IdParam, LogModifiedBy, DtValidFrom, DtValidTo, DtCreated) values (58, (select cp.IdParam from PCONFIGPARAM cp, CCOMPONENT c where cp.IdComponent = c.IdComponent and cp.NmParam = 'EF_representative_list'), null, ${valid.from}, null, ${valid.from});
insert into DSETTINGVALUE (IdValue, TxtValue, IdConfigSetting, DtCreated) values (71, 'functions.drl',  (select IdParam from PCONFIGPARAM where NmParam = 'EF_representative_list'), ${valid.from});
insert into DSETTINGVALUE (IdValue, TxtValue, IdConfigSetting, DtCreated) values (72, 'representative.drl',  (select IdParam from PCONFIGPARAM where NmParam = 'EF_representative_list'), ${valid.from});

-- List of drl files pertaining to the identifier creator
insert into PCONFIGPARAM (IdParam, DscParam, IsHidden, NmParam, PrmSource, TyParam, IdComponent) values (59, 'The identifier creator list', 0, 'EF_application_identifier_list', 0, 1, (select IdComponent from CCOMPONENT c where c.NmComponent='eu.ohim.sp.core.rules'));
insert into DCONFIGSETTING (IdConfigSetting, IdParam, LogModifiedBy, DtValidFrom, DtValidTo, DtCreated) values (59, (select cp.IdParam from PCONFIGPARAM cp, CCOMPONENT c where cp.IdComponent = c.IdComponent and cp.NmParam = 'EF_application_identifier_list'), null, ${valid.from}, null, ${valid.from});
insert into DSETTINGVALUE (IdValue, TxtValue, IdConfigSetting, DtCreated) values (73, 'identifierCreator.drl',  (select IdParam from PCONFIGPARAM where NmParam = 'EF_application_identifier_list'), ${valid.from});

-- List of drl files pertaining to the other attachments list parameter
insert into PCONFIGPARAM (IdParam, DscParam, IsHidden, NmParam, PrmSource, TyParam, IdComponent) values (60, 'The other attachments list', 0, 'EF_other_attachments_list', 0, 1, (select IdComponent from CCOMPONENT c where c.NmComponent='eu.ohim.sp.core.rules'));
insert into DCONFIGSETTING (IdConfigSetting, IdParam, LogModifiedBy, DtValidFrom, DtValidTo, DtCreated) values (60, (select cp.IdParam from PCONFIGPARAM cp, CCOMPONENT c where cp.IdComponent = c.IdComponent and cp.NmParam = 'EF_other_attachments_list'), null, ${valid.from}, null, ${valid.from});
insert into DSETTINGVALUE (IdValue, TxtValue, IdConfigSetting, DtCreated) values (74, 'functions.drl',  (select IdParam from PCONFIGPARAM where NmParam = 'EF_other_attachments_list'), ${valid.from});
insert into DSETTINGVALUE (IdValue, TxtValue, IdConfigSetting, DtCreated) values (75, 'otherAttachments.drl',  (select IdParam from PCONFIGPARAM where NmParam = 'EF_other_attachments_list'), ${valid.from});
...
-- The map of rules maps
insert into PCONFIGPARAM (IdParam, DscParam, IsHidden, NmParam, PrmSource, TyParam, IdComponent) values (116, 'The list of projects with rule lists', 0, 'rules_map', 0, 1, (select IdComponent from CCOMPONENT c where c.NmComponent='eu.ohim.sp.core.rules'));
insert into DCONFIGSETTING (IdConfigSetting, IdParam, LogModifiedBy, DtValidFrom, DtValidTo, DtCreated) values (116, (select cp.IdParam from PCONFIGPARAM cp, CCOMPONENT c where cp.IdComponent = c.IdComponent and cp.NmParam = 'rules_map'), null, '2012-09-28 00:00:00', null, '2012-09-28 00:00:00');
insert into DSETTINGVALUE (IdValue, TxtValue, IdConfigSetting, DtCreated) values (133, 'EF_rules',  (select IdParam from PCONFIGPARAM where NmParam = 'rules_map'), '2012-09-28 00:00:00');
insert into DSETTINGVALUE (IdValue, TxtValue, IdConfigSetting, DtCreated) values (134, 'DS_rules',  (select IdParam from PCONFIGPARAM where NmParam = 'rules_map'), '2012-09-28 00:00:00');
insert into DSETTINGVALUE (IdValue, TxtValue, IdConfigSetting, DtCreated) values (135, 'BO_rules',  (select IdParam from PCONFIGPARAM where NmParam = 'rules_map'), '2012-09-28 00:00:00');

-- The TM rules map
insert into PCONFIGPARAM (IdParam, DscParam, IsHidden, NmParam, PrmSource, TyParam, IdComponent) values (117, 'The rules lists for EF_rules map', 0, 'EF_rules', 0, 1, (select IdComponent from CCOMPONENT c where c.NmComponent='eu.ohim.sp.core.rules'));
insert into DCONFIGSETTING (IdConfigSetting, IdParam, LogModifiedBy, DtValidFrom, DtValidTo, DtCreated) values (117, (select cp.IdParam from PCONFIGPARAM cp, CCOMPONENT c where cp.IdComponent = c.IdComponent and cp.NmParam = 'EF_rules'), null, '2012-09-28 00:00:00', null, '2012-09-28 00:00:00');
insert into DSETTINGVALUE (IdValue, TxtValue, IdConfigSetting, DtCreated) values (136, 'EF_rule_list',  (select IdParam from PCONFIGPARAM where NmParam = 'EF_rules'), '2012-09-28 00:00:00');
insert into DSETTINGVALUE (IdValue, TxtValue, IdConfigSetting, DtCreated) values (137, 'EF_registration_number_list',  (select IdParam from PCONFIGPARAM where NmParam = 'EF_rules'), '2012-09-28 00:00:00');
insert into DSETTINGVALUE (IdValue, TxtValue, IdConfigSetting, DtCreated) values (138, 'EF_fee_list',  (select IdParam from PCONFIGPARAM where NmParam = 'EF_rules'), '2012-09-28 00:00:00');
insert into DSETTINGVALUE (IdValue, TxtValue, IdConfigSetting, DtCreated) values (139, 'EF_goodsandservices_list',  (select IdParam from PCONFIGPARAM where NmParam = 'EF_rules'), '2012-09-28 00:00:00');
insert into DSETTINGVALUE (IdValue, TxtValue, IdConfigSetting, DtCreated) values (140, 'EF_applicant_list',  (select IdParam from PCONFIGPARAM where NmParam = 'EF_rules'), '2012-09-28 00:00:00');
insert into DSETTINGVALUE (IdValue, TxtValue, IdConfigSetting, DtCreated) values (141, 'EF_trademark_list',  (select IdParam from PCONFIGPARAM where NmParam = 'EF_rules'), '2012-09-28 00:00:00');
insert into DSETTINGVALUE (IdValue, TxtValue, IdConfigSetting, DtCreated) values (142, 'EF_claim_list',  (select IdParam from PCONFIGPARAM where NmParam = 'EF_rules'), '2012-09-28 00:00:00');
insert into DSETTINGVALUE (IdValue, TxtValue, IdConfigSetting, DtCreated) values (143, 'EF_representative_list',  (select IdParam from PCONFIGPARAM where NmParam = 'EF_rules'), '2012-09-28 00:00:00');
insert into DSETTINGVALUE (IdValue, TxtValue, IdConfigSetting, DtCreated) values (144, 'EF_application_identifier_list',  (select IdParam from PCONFIGPARAM where NmParam = 'EF_rules'), '2012-09-28 00:00:00');
insert into DSETTINGVALUE (IdValue, TxtValue, IdConfigSetting, DtCreated) values (145, 'EF_other_attachments_list',  (select IdParam from PCONFIGPARAM where NmParam = 'EF_rules'), '2012-09-28 00:00:00');
