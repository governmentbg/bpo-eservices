 ...
 *  * * . _ . *
 */
package eu.ohim.sp.core.domain.converter.tm.util;
...
public class JavaBeanTester {
    ...
    private static Object buildValue(Class<?> clazz) throws InstantiationException, IllegalAccessException,
        ...
        if (clazz == String.class)
            ...
            return list;
        } else if (clazz == KindMark.class) {
            return KindMark.INDIVIDUAL;
        ...
        } else if (clazz == RecordCurrentStatusCode.class) {
            return RecordCurrentStatusCode.RECORD_FILED;
        ...
        } else if (clazz == TermAssessmentType.class) {
            return TermAssessmentType.CONTROLLED_TERM;
        } else if (clazz == DocumentKind.class) {
            return DocumentKind.APPLICATION_CONFIRMATION;
        } else if (clazz == PaymentKindType.class) {
            return PaymentKindType.CREDIT_CARD;
        } else if (clazz == PaymentStatusCode.class) {
            return PaymentStatusCode.BANK_TRANSFER_TO_FOLLOW;
            ...
            return NameKind.NATURAL_PERSON;
        } else if (clazz == ExhibitionStatusCodeType.class) {
            return ExhibitionStatusCodeType.ACCEPTED;
            ...
            return PriorityStatusCodeType.ABANDONED;
