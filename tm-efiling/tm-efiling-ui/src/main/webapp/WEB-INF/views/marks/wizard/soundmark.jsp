...
<form:form modelAttribute="flowBean" id="formEF" cssClass="mainForm" method="POST">
        ...
        <jsp:include page="../wizard_templates/mark_sound_file.jsp">
            <jsp:param name="helpMessageKey" value="mark.soundFile.attachment.help"/>
            <jsp:param name="helpUseFlowModeId" value="false"/>
        </jsp:include>
        <jsp:include page="../wizard_templates/mark_sound_description.jsp"/>
        <jsp:include page="../wizard_templates/mark_sound_description_second.jsp"/>
