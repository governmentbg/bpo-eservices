...
<c:set var="sectionId" value="multimediamark" scope="request"/>
...
<form:form modelAttribute="flowBean" id="formEF" cssClass="mainForm" method="POST">
    ...
    <jsp:include page="../wizard_templates/multimedia_representation.jsp">
    ...
    <form:hidden path="mainForm.markType" value="multimediamark"/>
</form:form>
