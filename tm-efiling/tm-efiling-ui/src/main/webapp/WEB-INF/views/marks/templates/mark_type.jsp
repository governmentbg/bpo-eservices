    ...
    <div class="controls" id="markType">
        <div class="col-400">
            <component:checkbox path="mainForm.collectiveMark"
                                ...
                                labelTextCode="mark.isCollective" formTagClass="checkerCollective fasttrackinput-ignore"/>
            <component:checkbox path="mainForm.certificateMark"
                                checkRender="true" id="certificateMark"
                                labelTextCode="mark.isCertificate" formTagClass="checkerCertificate fasttrackinput-ignore"/>
        </div>
