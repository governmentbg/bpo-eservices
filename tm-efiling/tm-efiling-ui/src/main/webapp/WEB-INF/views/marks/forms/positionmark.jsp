...
<form:form modelAttribute="flowBean" cssClass="mainForm formEF"
           method="POST">
        <c:set var="sectionId" value="positionmark" scope="request"/>

		<header>
			<h3><spring:message code="mark.names.position"/></h3>
		</header>	
            ...
            <form:hidden path="mainForm.markType" value="positionmark"/>
</form:form>
