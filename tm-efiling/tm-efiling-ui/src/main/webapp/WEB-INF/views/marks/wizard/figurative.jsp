...
<c:set var="sectionId" value="figurative" scope="request"/>
...
<form:form modelAttribute="flowBean" id="formEF" cssClass="mainForm" method="POST">
    ...
    <jsp:include page="../wizard_templates/mark_transliteration.jsp"/>
    ...
    <form:hidden path="mainForm.markType" value="figurative"/>
</form:form>
