...
<form:form cssClass="fileUploadForm formEF" id="representativeLawyerCompanyForm" modelAttribute="representativeLawyerCompanyForm">
    <c:set var="imported" value="${representativeLawyerCompanyForm.imported}" scope="request"/>
    <c:set var="sectionId" value="representative_lawyercompany" scope="request"/>
    ...
    <input type="hidden" class="reptypehidden" value="${representativeLawyerCompanyForm.type}"/>
    ...
    <component:generic path="correspondenceAddresses" checkRender="false">
        ...
        <jsp:include page="/WEB-INF/views/partials/correspondenceAddress.jsp">
            ...
            <jsp:param name="itemFilterValue" value="isRepresentative"/>
            <jsp:param name="size" value="${representativeLawyerCompanyForm.correspondenceAddresses.size()}"/>
        </jsp:include>
    </component:generic>
    ...
    <div id="fileDocumentAttachment" class="fileuploadInfo collectiveSelectors">            
        <component:file pathFilename="fileDocumentAttachment" fileWrapperPath="representativeAttachment" labelCode="representative.legalEntity.field.attachment"
                        fileWrapper="${representativeLawyerCompanyForm.representativeAttachment}"/>
	</div>
    ...
    <jsp:include page="/WEB-INF/views/partials/representative_pow_details.jsp" />
	 ...
	 <ul class="controls">
        ...
        <li>
            <button class="addRepresentative addRepresentativeLawyerCompany" type="button">
                <i class="add-icon"/>
