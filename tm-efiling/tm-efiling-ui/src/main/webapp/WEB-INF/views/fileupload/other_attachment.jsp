...
<section class="attachments" id="otherAttachments">
    ...
    <form:form class="mainForm formEf" modelAttribute="flowBean">
        <c:set var="hidden" value="${flowBean.otherAttachments != null && flowBean.otherAttachments.storedFiles != null && flowBean.otherAttachments.attachment
        ? '': 'hidden'}"/>
        <div class="${hidden}" id="otherAttachmentsDeclaration">
            <component:checkbox path="trueDocumentsIndicator" checkRender="true" id="trueDocumentsIndicator"
                                labelTextCode="otherAttachments.trueDocumentsDeclaration"/>
        </div>
    </form:form>
</section>