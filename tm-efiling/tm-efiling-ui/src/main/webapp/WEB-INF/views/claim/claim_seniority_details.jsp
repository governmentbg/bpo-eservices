            ...
            <fieldset>
	            ...
	            <div id="newFormDetails" class="${newFormDetailsClass}">
			        <c:if test="${service_seniority_import && (security_seniority_import || !configurationServiceDelegator.securityEnabled)}">
                        ...
                        <button id="" class="importSeniority" data-ask="true" type="button"><spring:message code="claim.action.import" /></button>
                ...
                <div id="manualDetails" class="${manualDetailsClass}">
                  	<component:select items="${configurationServiceDelegator.getSeniorityNaturesByModule('tmefiling')}" labelTextCode="claim.seniority.field.nature" path="nature"
	                                 itemLabel="value"
	                                 itemValue="code" checkRender="true"/>		                  	                    
